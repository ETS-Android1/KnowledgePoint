...
//
/**
 * Populates each row of a ListView with multiple data items, each related to a selectable document.
 * 
 * @author tony.hillman@ultra-as.com
 * 
 */
public class AdapterForSuite extends BaseAdapter 
{   
	/**
	...
	/**
	 * The constructor for the AdapterForSuite class. Instantiates a LayoutInflater, so that an 
	 ...
	 *            
	 */
    public AdapterForSuite(Activity a, ArrayList<HashMap<String, String>> d) 
    { 
        ...
        // The Image Loader class is used for accessing image files either locally or over
        // the network, employing concurrency in cases of temporary unavailability, and
        // decoding images to bitmaps for display.
        //
    ...
    public View getView(int position, View convertView, ViewGroup parent) 
    {
        ...
        //
        // if(convertView==null)
        //     vi = inflater.inflate(R.layout.list_row_content_for_suite_for_seven_zero___five_point_seven, null);
        ...
        if (convertView == null)
        {
			switch (MetaDataForSuite.currentAspectRatio)
			{
				...
				//
				case 0:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_zero___four_point_three, null);
					Log.w(TAG0, "Inflated suite row definition for 0.\n");
					break;
					
				// This is a 540x960 4.0" to 4.8" device.
 		        //
 		        case 10:
 		        	vi = inflater.inflate(R.layout.list_row_content_for_suite_for_one_zero___four_point_zero_etc, null);
					Log.w(TAG0, "Inflated suite row definition for 10.\n");
					break;
					
	    		// This is a 720x1280 4.3" to 5.0" device.
	        	//
	        	case 20:
	        		vi = inflater.inflate(R.layout.list_row_content_for_suite_for_two_zero___four_point_three_etc, null);
	        		Log.w(TAG0, "Inflated suite row definition for 20.\n");
	        		break;	
	        		
    			// This is a 768x1280 4.7" device.
    		    //
    			case 30:
    				vi = inflater.inflate(R.layout.list_row_content_for_suite_for_three_zero___four_point_seven, null);
    				Log.w(TAG0, "Inflated suite row definition for 30.\n");
    				break;
    				
				// This is a 800x1280 7" device.
			    //
				case 40:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_four_zero___seven, null);
					Log.w(TAG0, "Inflated suite row definition for 40.\n");
					break;
					
				// This is a 800x1280 10.1" device.
			    //
				case 50:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_five_zero___ten, null);
				...
				//
				case 60:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_six_zero___gen, null);
					Log.w(TAG0, "Inflated suite row definition for 60.\n");
					break;
				...
				case 70:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_seven_zero___five_point_seven, null);
					Log.w(TAG0, "Inflated suite row definition for 70.\n");
					break;
				
				// This is a 1200x1920 7 inch device.
				//
				case 80:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_eight_zero___seven, null);
					Log.w(TAG0, "Inflated suite row definition for 80.\n");
					break;
				
				// This is a 1200x1920 10 inch device.
				//
				case 90:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_nine_zero___ten, null);
					Log.w(TAG0, "Inflated suite row definition for 90.\n");
					break;
					
	        	// This is a 1440x900 7 inch device.
 	        	//	
 	        	case 100:
 	        		vi = inflater.inflate(R.layout.list_row_content_for_suite_for_one_zero_zero___seven, null);
 	        		Log.w(TAG0, "Inflated suite row definition for 100.\n");
 	        		break;

				// This is a 1440x2560 5.1 inch device.
				//
				case 110:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_one_one_zero___five_point_one, null);
					Log.w(TAG0, "Inflated suite row definition for 110.\n");
					break;
				...
				default:
					vi = inflater.inflate(R.layout.list_row_content_for_suite_for_six_zero___gen, null);
					Log.w(TAG0, "Inflated suite row definition for default.\n");
					break;			
			}
        }  
        ...
        //
        TextView selected_document_id = (TextView)vi.findViewById(R.id.hidden_id); 
        
        // Title of document.
        //
        TextView title = (TextView)vi.findViewById(R.id.doc_title); 
        ...
        // CustomizedContentListView.java.
        //
        HashMap<String, String> selected_document = new HashMap<String, String>();
        selected_document = data.get(position);
        
        // Set all of the values in the current list row object according to the
        // values that are in the hash map we've received. 
        //
        selected_document_id.setText(selected_document.get(ListViewForSuiteActivity.KEY_ID));
        
        title.setText(selected_document.get(ListViewForSuiteActivity.KEY_DOC_TITLE));
        
        artist.setText(selected_document.get(ListViewForSuiteActivity.KEY_DESCRIPTION));
        
        imageLoader.DisplayImage(selected_document.get(ListViewForSuiteActivity.KEY_THUMBNAIL), thumb_image);
